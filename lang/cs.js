    ...
    step5: {
        ...
        ai: {
            ...
            prompt: {
                ...
                body: "Analyzujte snímek repozitáře v jazyce uživatele a vygenerujte pouze optimalizovaný seznam k přeskočení ve formátu fnmatch, připravený k použití, který vyloučí šum bez poškození architektury: použijte přesné názvy k odstranění konkrétních složek nebo souborů, zástupné znaky (wildcards) pro opakující se rodiny souborů a široké vzory s opatrností; vezměte v úvahu, že každé pravidlo se může shodovat s názvem položky i s celou cestou, a pokud se složka shoduje, celá větev by měla být ignorována. Odstraňte testy, nepodstatné dokumenty, binární soubory, mezipaměti, protokoly, buildy, zámky, dočasné soubory, tajemství a redundance, ale zachovejte funkční jádro, moduly, běhové prostředí, poskytovatele, adaptéry, tok provádění a vše, co podporuje strukturální porozumění systému.\n\nV případě pochybností zachovejte relevantní kód a vylučte pouze šum.\n\nUpřednostněte vzory jako:\n*test*\n*tests*\n*docs*\n*example*\n*examples*\n*bench*\n*benchmark*\n*fixture*\n*fixtures*\n*mock*\n*mocks*\n*__pycache__*\n*node_modules*\n*.log\n*.lock\n*.tmp\n*.cache\ndist*\nbuild*\ntarget*\ncoverage*",

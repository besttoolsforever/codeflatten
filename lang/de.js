    ...
    step5: {
        ...
        ai: {
            ...
            prompt: {
                ...
                body: "Analysieren Sie den Repository-Snapshot in der Sprache des Benutzers und generieren Sie nur eine optimierte Skip-List im fnmatch-Muster, einsatzbereit, die Rauschen ausschließt, ohne die Architektur zu beschädigen: Verwenden Sie exakte Namen, um bestimmte Ordner oder Dateien zu entfernen, Wildcards für wiederkehrende Dateifamilien und breite Muster mit Vorsicht; berücksichtigen Sie, dass jede Regel sowohl mit dem Elementnamen als auch mit dem vollständigen Pfad übereinstimmen kann, und dass bei Übereinstimmung mit einem Ordner der gesamte Zweig ignoriert werden sollte. Entfernen Sie Tests, nicht wesentliche Dokumente, Binärdateien, Caches, Protokolle, Builds, Sperren, temporäre Artefakte, Geheimnisse und Redundanzen, aber bewahren Sie den funktionalen Kern, Module, Laufzeit, Provider, Adapter, Ausführungsfluss und alles, was das strukturelle Verständnis des Systems unterstützt.\n\nIm Zweifelsfall bewahren Sie relevanten Code auf und schließen Sie nur Rauschen aus.\n\nPriorisieren Sie Muster wie:\n*test*\n*tests*\n*docs*\n*example*\n*examples*\n*bench*\n*benchmark*\n*fixture*\n*fixtures*\n*mock*\n*mocks*\n*__pycache__*\n*node_modules*\n*.log\n*.lock\n*.tmp\n*.cache\ndist*\nbuild*\ntarget*\ncoverage*",

window.translations.tr = {
    ...
    step5: {
        ...
        ai: {
            ...
            prompt: {
                label: "Örnek istek",
                body: "Kullanıcının dilinde depo anlık görüntüsünü (snapshot) analiz edin ve mimariye zarar vermeden gürültüyü hariç tutan, fnmatch deseninde optimize edilmiş kullanıma hazır bir atlama listesi (skip list) oluşturun: belirli klasörleri veya dosyaları kaldırmak için tam adları, tekrarlayan dosya aileleri için joker karakterleri (wildcards) ve geniş desenleri dikkatli kullanın; her kuralın hem öğe adıyla hem de tam yolla eşleşebileceğini ve bir klasör eşleştiğinde tüm dalın yoksayılması gerektiğini unutmayın. Testleri, gereksiz belgeleri, ikili (binary) varlıkları, önbellekleri, günlükleri (logs), derlemeleri (builds), kilitleri (locks), geçici yapıları, sırları (secrets) ve fazlalıkları kaldırın, ancak işlevsel çekirdeği, modülleri, çalışma zamanını (runtime), sağlayıcıları (providers), bağdaştırıcıları (adapters), yürütme akışını ve sistemin yapısal anlaşılmasını destekleyen her şeyi koruyun.\n\nŞüphe duyduğunuzda, ilgili kodu koruyun ve yalnızca gürültüyü hariç tutun.\n\nŞu gibi desenlere öncelik verin:\n*test*\n*tests*\n*docs*\n*example*\n*examples*\n*bench*\n*benchmark*\n*fixture*\n*fixtures*\n*mock*\n*mocks*\n*__pycache__*\n*node_modules*\n*.log\n*.lock\n*.tmp\n*.cache\ndist*\nbuild*\ntarget*\ncoverage*",
